...
const About = () => {
  return (
    <section
      id="about"
      className="py-24 bg-gradient-to-b from-[#111827] to-[#0f172a]"
    >
      <div className="max-w-7xl mx-auto px-8">
        ...
        <motion.h2
          ...
          className="text-4xl md:text-5xl font-bold text-center text-white mb-5"
        >
        ...
        <motion.p
          ...
          className="text-center text-slate-400 max-w-3xl mx-auto mb-14 text-lg"
        >
        ...
        <motion.div
          ...
          className="bg-slate-800/70 backdrop-blur-md border border-slate-700 rounded-2xl p-10 shadow-2xl"
        >
          <p className="text-slate-300 text-lg leading-9">
            I'm a passionate <span className="text-indigo-400 font-semibold">Full Stack MERN Developer</span> with
            ...
            My expertise includes <span className="text-cyan-400">React.js</span>,
            ...
            I have solved <span className="text-indigo-400 font-semibold">200+ LeetCode problems</span>,
